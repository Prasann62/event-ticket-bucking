...
const Footer = () => {
    ...
    return (
        <footer className="bg-brand-bg pt-24 pb-12 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-brand-blue/10 to-transparent blur-sm"></div>
                        ...
                        <div className="flex space-x-4">
                            {[Twitter, Instagram, Github, Linkedin].map((Icon, i) => (
                                <motion.a
                                    ...
                                    className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-brand-cyan hover:border-brand-cyan transition-all shadow-lg"
                                >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue transition-all"
                            />
                            <button className="absolute right-2 top-1/2 -translate-y-1/2 p-2 hover:text-brand-cyan transition-colors">
